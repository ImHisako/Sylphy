...
Gli script compilano il core con le feature `veilid,signal-ratchet`. La build richiede anche il compilatore Protobuf `protoc`; Android usa NDK `28.2.13676358`, Java 17, i target Rust e `cargo-ndk`, Windows Visual Studio Build Tools con C++, Linux Clang/CMake/Ninja, GTK 3 e liblzma. I dettagli dell'ABI, delle route private e del bootstrap Android sono in `native/README.md` e `specs/native-core.md`.
